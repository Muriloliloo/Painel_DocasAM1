...
DECLARE facility_filter STRING DEFAULT @facility_id;
DECLARE cycle_filter STRING DEFAULT @cycle_name;
DECLARE date_from DATE DEFAULT @operation_date;
DECLARE date_to DATE DEFAULT @operation_date;
...
-- SELECT process_id, COUNT(*) AS row_count
-- FROM final_result
-- GROUP BY process_id
-- HAVING COUNT(*) > 1
